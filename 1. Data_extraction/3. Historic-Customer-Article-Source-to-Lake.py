...
customers_df.repartition(1).write.parquet(f"s3://datalake-rawzone-group1dbda-8sept/Customers/Customers_historic/{current_date_string}/")

articles_df.repartition(1).write.parquet(f"s3://datalake-rawzone-group1dbda-8sept/Articles/Articles_historic/{current_date_string}/")
